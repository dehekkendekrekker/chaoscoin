...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Chaoscoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"chaoscoin.org", "dnsseed.chaoscoin.org"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"chaoscoin.org", "testnet-seed.chaoscoin.org"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Chaoscoin is probably already running."), addrBind.ToString().c_str());
        else
